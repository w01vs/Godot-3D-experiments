...
# Health changes?
@export var type: HealthComponent.ChangeType:
	set(value):
		type = value
...
func _validate_property(property: Dictionary) -> void:
	enable_if(property, "time_per_tick", type == HealthComponent.ChangeType.DOT)
	enable_if(property, "change_per_tick", type == HealthComponent.ChangeType.DOT)
	enable_if(property, "ticks", type == HealthComponent.ChangeType.DOT)
	enable_if(property, "health_change_total", type == HealthComponent.ChangeType.INSTANT)
	enable_if(property, "damage_multiplier", type == HealthComponent.ChangeType.INSTANT)
